...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="space-y-12 md:space-y-24 pb-20 overflow-hidden">
      ...
      {/* Featured Banner with Glimmer - Sized down as requested */}
      <section className="max-w-7xl mx-auto px-4">
        <a 
          href="https://toolsybro.com" 
          target="_blank" 
          rel="noopener noreferrer"
          className="group block relative overflow-hidden bg-zinc-900 rounded-[2.5rem] p-8 md:p-10 shadow-2xl transition-all duration-700 hover:scale-[1.005]"
        >
          <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-accent/15 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3 group-hover:bg-accent/25 transition-all duration-1000"></div>
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div className="space-y-4 flex-grow max-w-2xl">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 backdrop-blur-md rounded-full text-white font-black text-[9px] uppercase tracking-[0.3em] border border-white/5">
            ...
            <div className="flex-shrink-0">
              <div className="bg-white text-zinc-900 px-8 py-4 rounded-2xl font-black text-[11px] uppercase tracking-widest flex items-center gap-3 group-hover:bg-accent group-hover:text-white transition-all duration-500 shadow-xl glimmer-btn">
